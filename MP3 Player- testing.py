...
from random import *
from os import *
#C:/Users/sangh/Downloads/Python/MP3 Player/
root = Tk()
...
Remove = 0
directory = input("Copy + Paste your downloads directory (replace forward slashes with backslashes) : ")
location = (directory)
...
Disk = PhotoImage (file= directory+'MusicDisk.png')
...
img1 = PhotoImage(file= directory+"start!.gif")
...
img2 = PhotoImage(file= directory+"unpause.gif")
...
img3 = PhotoImage(file= directory+"pause.gif")
...
img4 = PhotoImage(file= directory+"stop.gif")
